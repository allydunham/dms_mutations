...
# Process Average
head -n 9 Average_0_${PDB_ID}_repair.fxout > Average_${PDB_ID}_repair.fxout
tail -n +10 -q Average_*_${PDB_ID}_repair.fxout >> Average_$PDB_ID.fxout
#rm Average_*_${PDB_ID}_repair.fxout

# Process Dif
head -n 9 Dif_0_${PDB_ID}_repair.fxout > Dif_${PDB_ID}_repair.fxout
tail -n +10 -q Dif_*_${PDB_ID}_repair.fxout >> Dif_${PDB_ID}_repair.fxout
#rm Dif_*_${PDB_ID}_repair.fxout

# Process Raw
head -n 9 Raw_0_${PDB_ID}_repair.fxout > Raw_${PDB_ID}_repair.fxout
